...
const TryNewApi = () => {
   ...
   const fetchData = async () => {
      const url = `https://api.mediastack.com/v1/news?access_key=ae53aa20f05384fe8e72ce38f2b5b530&limit=${limit}`
      try {
   ...
   const renderArticle = (article: NewArticle, index: number) => (
